...
## Retrospective results through scan 60
...
Scan 45 is the mixed Chapter 4 / Chapter 5 boundary with centered source heading `5`. Scan 52 is the source-printed Chapter 6 opening with centered `6`. Scan 59 is the mixed Chapter 6 / Chapter 7 boundary with centered `7`.
...
Perform the **retrospective historical-glyph re-audit of scans 61–65** as the next 5-scan iteration. Synchronize page records/audit/status documents and commit only positively supported corrections. Continue retrospectively in 5-scan batches through scan 101. Only then resume forward work at scan 112.
