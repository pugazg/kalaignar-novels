...
- historical-glyph coverage on existing canonical scans: **PASS scans 1–128**;
- forward transcription: **next 5-page iteration scans 129–133**;
...
Process **scans 129–133** as one 5-page forward iteration using the bounded production workflow: full-page transcription first, one 5-page glyph sweep, and at most one targeted enlargement per genuinely unclear token before recording a source hold. Do not start assembled Tamil or English.
