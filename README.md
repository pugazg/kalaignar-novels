...
- historical-glyph/source-sensitive checks: **PASS through scan 35**;
- full Tamil source audit: **not started**;
- assembled Tamil: **not started**;
- English translation: **blocked until Tamil gate passes**;
- next activity when explicitly instructed: process **scan 36** directly from source pixels and continue Chapter 4; do not infer its printed number or start assembled Tamil/English.
...
For `வெள்ளிக்கிழமை`, scans 4–35 have passed direct transcription and historical-glyph checking. Scan 33 preserves the physical Chapter 3 / Chapter 4 boundary exactly; scans 34–35 continue Chapter 4 from the source without moving text across scan boundaries. Scan 35 includes a source-supported old-form `னா` resolution in `பட்டினால்`.
