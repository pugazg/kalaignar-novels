...
- Chapter 11: **scan 92 below centered `11` through scan 96 — verified continuation**;
- historical-glyph/source-sensitive checks: **PASS through scan 96**;
- full Tamil source audit: **not started**;
- assembled Tamil: **not started**;
- English translation: **blocked until Tamil gate passes**;
- next 5-scan iteration: **scans 97–101**.

### Durable name correction — `நயினா`

The recurring character name is **`நயினா`**, not `நயினு`. Reinspection of the controlling scan shows that the historical `னா` typeform had been misread as `னு`. Scan 34 directly gives the same-edition witness `நயினா என்பது நயினாமுகம்மது என்ற பெயரின் சுருக்கம்`. Canonical scans 34–96 use `நயினா`; future transcription must not regress to `நயினு`.

### Source-number anomaly — scan 66

Scan **66** visibly prints only **`5`** at the page-number positions; no tens digit is present even under enlarged/native inspection. Canonical `printed_page` therefore records the visible source value `5` rather than silently inferring `65`. Scans 67–96 visibly print `66–95`.
