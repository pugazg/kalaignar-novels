...
- missing physical scan records: **0**;
...
- unresolved readings: **0**;
- scan81 `பூணால் வலையில்`: **CONFIRMED / RETAINED**;
- scan82 source wordplay: **`வைப்பு / ஒய்ப் / வைப்` CONFIRMED**;
- scan84 `பதி சொல் தட்டாத`: **CONFIRMED / RETAINED**;
- all 13 historical-glyph-sensitive families explicitly considered on every page;
- review record: [`T2_SCANS_080_084.md`](T2_SCANS_080_084.md).
