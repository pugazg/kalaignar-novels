...
- scans 80–94 — T1/T2/T3 complete / **verified**; visible printed pages **78–92**; chapter transitions **10→11** at scan85 and **11→12** at scan91 re-confirmed; T2 corrections **6**; T3 additional corrections **0**; unresolved after T3 **0**; scan94 ends `முத்தாய்ப்பு வைத்தார் அவர்.`; scan95 not opened;
...
13. exact next: **T1 scans95–109 only — 15 physical pages**;
