...
- scans 20–21 — T1 complete / `needs-review`; visible printed pages **18–19**;
- scan 22 — T1 complete / `needs-review`; visible printed page **20**; centered chapter **2** begins mid-page;
- scans 23–24 — T1 complete / `needs-review`; visible printed pages **21–22**;
...
14. **T2 independent historical-glyph/source-form review for scans 20–24 is NEXT**;
