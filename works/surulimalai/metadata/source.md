...
- scans 50–54 — T1 complete / **needs-review** pending T2; visible printed pages **48–52**; chapter **5** continues; scan49→50 split `அந்தப்பேய்` / `அவள் எதிரே...`; scan54 ends `போனால் திரும்ப மாட்டேண்டி வெள்ளையம்மா!`; scan55 not opened;
...
4. scans **50–54 T1 COMPLETE / PASS — 5/5 needs-review pending T2**;
...
9. exact next: **T2 scans50–54 only**;
