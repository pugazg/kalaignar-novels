...
- scans 80–94 — T1/T2 complete / **needs-review** pending T3; visible printed pages **78–92**; chapter transitions **10→11** at scan85 and **11→12** at scan91; T2 corrections **6**; unresolved after T2 **0**; scan87→88 `சூசக` / `மான`; scan91→92 `கூடிவிட்` / `டனர்.`; scan94 ends `முத்தாய்ப்பு வைத்தார் அவர்.`;
...
7. scans **80–94 T1/T2 COMPLETE / PASS — 15/15 needs-review pending T3**;
...
13. exact next: **T3 scans80–94 only — 15 physical pages**;
