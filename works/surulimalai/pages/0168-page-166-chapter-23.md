...
- physical scan **168** / visible printed page **166** transcribed from user-supplied source-readable split `TVA_BOK_0064107_சுருளிமலை_1968_part_006_pages_151-180.pdf`;
- split extract page **18** corresponds to physical scan **168**;
...
- source-visible centered chapter marker **23** occurs on this physical page;
