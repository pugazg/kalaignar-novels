...
- physical scan **181** / visible printed page **179** transcribed from user-supplied split `TVA_BOK_0064107_சுருளிமலை_1968_part_007_pages_181-198.pdf`, extract page **1**;
- part006→part007 boundary at scan180→181 re-confirmed; scan181 opens with `என்ன நிபந்தனை?`;
- source-visible centered chapter marker **25** occurs on this physical page;
