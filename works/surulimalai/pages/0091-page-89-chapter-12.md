...
- scan90→91 continuity is sentence-level: scan90 ends `சம்மதம் தந்தான்.` and scan91 begins `தெருக்கதவு திறக்கப்பட்டது.`;
- source-visible chapter marker **12** begins mid-page after the opening chapter-11 continuation;
- physical page ends mid-word at `கூடிவிட்ட`; scan92 continues `னர்.`;
- `ஒலியில்லை` and chapter-transition punctuation are explicit T2 targets;
