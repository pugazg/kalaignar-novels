...
- final source-fidelity review: **scans 5–19 T3 COMPLETE / PASS / VERIFIED; scans 20–24 T3 NEXT**;
...
Perform **T3 final source-fidelity review for scans 20–24 only** from the attached source pixels. Keep pages `needs-review` until each passes T3, update controls, commit, and stop before scan25. The 198-page ingestion discrepancy remains deferred.
