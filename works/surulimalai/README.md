...
- canonical body transcription: **T1/T2/T3 scans 5–54 COMPLETE / PASS / VERIFIED**;
...
- scans 50–54 — chapter 5 body; T1/T2/T3 complete / **verified**; visible printed pages **48–52**; T2 corrections **1** (`உளர`→`உளற`); T3 additional corrections **0**; scan49→50 continuation `அந்தப்பேய்` / `அவள் எதிரே...`; scan54 ends `போனால் திரும்ப மாட்டேண்டி வெள்ளையம்மா!`; scan55 not opened;
...
Begin **T1 direct visual transcription for scans55–64 only — 10 physical pages**. Use the supplied `surulimalai.md` only as a baseline/navigation aid and keep the controlling PDF scan pixels authoritative. Create ten canonical records, mark them `needs-review`, update controls, commit, and stop before T2. The 198-page ingestion discrepancy remains deferred.
