...
- canonical body transcription: **scans 5–19 VERIFIED; scans 20–24 T1 COMPLETE / PASS — 5/5 `needs-review`**;
- historical-glyph review: **scans 5–19 T2 COMPLETE / PASS; scans 20–24 T2 NEXT**;
...
- scans 20–21 — chapter 1 body; T1 complete / `needs-review`; visible printed pages **18–19**;
- scan 22 — printed page **20**; T1 complete / `needs-review`; chapter **2** begins mid-page after two closing paragraphs;
- scans 23–24 — chapter 2 body; T1 complete / `needs-review`; visible printed pages **21–22**;
...
Perform **T2 independent historical-glyph/source-form review for scans 20–24 only** from the attached source pixels. Re-read all five pages independently, keep all records `needs-review`, update controls, commit, and stop before scan25. The 198-page ingestion discrepancy remains deferred.
...
Active T1 checkpoint: [`T1_BATCH_020_024.md`](T1_BATCH_020_024.md).
