...
Where the general novel workflow differs from the work-specific Part lock, the **work-specific Kuraloviyam-style Part closure rule governs**.

## Source family

- source family: **TVA_BOK_0065744**
- complete physical scans: **477**
- supplied split PDFs: **16/16**
- Parts001–015: **30 pages each**
- Part016: **27 pages**
- split coverage: **477/477**
- PDFs committed: **No**
- attached rendered source pages: controlling source
...
| Check | State |
|---|---|
| source family extent | **PASS — 477** |
| split files supplied | **PASS — 16/16** |
| global ranges | **PASS — 1–477 continuous** |
...
That progression is **REVOKED**.

Corrective actions:
- premature Part002 page records scans31–35 were deleted;
- the mixed `T1_BATCH_026_035.md` record was deleted;
- Part002 returned to **REGISTERED / TRANSCRIPTION BLOCKED**;
- scans1–2 were returned from premature `verified` to `needs-review`;
- the earlier local T2/T3 scans1–5 are retained only as historical preliminary review evidence;
- formal Part-level Pass 2A / Pass 2B / Pass 3 are reset to **NOT STARTED**;
- `PART_001_PASS1_PROGRESS.md` is now the authoritative live source-progress tracker.

## Active Part001

Range:
- overall scans **1–30**
- Part001 local pages **1–30**

Current Pass-1 accounting:
...
Part002 local1 is retained only as a boundary witness. No Part002 canonical transcription record is retained.

## Mandatory Part001 closure chain

Before Part002 transcription may begin, Part001 must complete:
...
4. Pass 3 — 30/30
5. Part audit
6. final metadata/status synchronization
7. documentation synchronization
8. Tamil archival-ready checkpoint
9. assembled Tamil construction + audit
10. English translation plan
11. English drafting
...
## Part002 assembled Tamil checkpoint — PASS / CLOSED

The Part002 derived Tamil reading layer is now closed:
...
- canonical Tamil page mutations caused by assembly — **0**;
- 30→31 — **GENUINE CONTINUATION / retained as provenance only**;
...
All five source-checked Part002 English files were reconciled together for recurring names, places, titles, source-facing vocabulary, political/military labels, source social labels, deliberate variants and Part-boundary integrity.
...
All five maintained Part002 Tamil/English section pairs were reviewed after editorial closure.

Result:
- Tamil/English pairs reviewed — **5/5**
- source coverage — **scans31–60 exactly**
- editorial corrections rechecked — **12/12 PASS**
- new English-only bilingual corrections — **3**
...
## Part003 Tamil archival-ready checkpoint — PASS / CLOSED

Part003 canonical Tamil is now archival-ready for normal workflow purposes:

- canonical records — **30/30 scans61–90**
- Tamil textual status — **30/30 verified**
- visual fidelity — **30/30 verified**
- partial / blocked / source-limited / needs-review — **0**
- unresolved Pass1 / Pass2A / historical-glyph / Pass3 / status exceptions — **0**
- Part audit — **PASS / COMPLETE**
- final metadata/status synchronization — **PASS / CLOSED**
- documentation synchronization — **PASS / COMPLETE**
- Tamil archival-ready — **PASS / CLOSED**
...
## Part004 verification / documentation state

Part004 has completed its maintained Tamil verification chain through documentation synchronization:
...
The live documentation/control surface has been reconciled to the verified Part004 state without changing any canonical Part004 page record.

Synchronized controls include README, handover, page map, work audit, source metadata, source-intake controls, multipart policy, Part004 progress trackers and root next-chat prompts.
...
## Part004 assembled Tamil checkpoint — PASS / CLOSED

The readable Part004 Tamil layer under `sections/` is now closed:
...
- incoming 90→91 GENUINE CONTINUATION provenance — **retained without importing scan90**
- outgoing 120→121 GENUINE CONTINUATION provenance — **retained without importing scan121**
...
Perform **Part004 English translation planning/setup**.

Do not draft English prose in the setup gate and do not begin Part005 transcription.

## Part004 English planning/setup — COMPLETE / PASS

The derived Part004 English control layer is initialized without drafting translated prose:

- active plan — `translations/en/PART_004_TRANSLATION_PLAN.md`
- active glossary — `translations/en/PART_004_GLOSSARY.md`
- active progress — `translations/en/PART_004_PROGRESS.md`
...
## Part013 outgoing boundary + final closure

- **390→391 — CLEAN CHAPTER BOUNDARY / AUDITED / PASS**
- audited multipart split boundaries — **13/15**
- Part013 release/readiness — **PASS / CLOSED**
- Part013 release-ready synchronization — **PASS / CLOSED**
- **PART013 FINAL CLOSURE — PASS / CLOSED / FROZEN**
- Parts001–013 — **FINAL CLOSED / FROZEN**
- Part014 — **NEXT ACTIVE / AUTHORIZED**
- exact next — **Part014 Pass1 Batch1 scans391–400**

## Part014 Pass1 Batch1 checkpoint

- scans391–400 — **TEXT-COMPLETE / 10/30**
- printed384–393
- textual / visual — **needs-review / needs-review**
- unresolved source-reading holds — **0**
- Pass2A — **blocked until Pass1 30/30**
- exact next — **Pass1 Batch2 scans401–410**

## Part014 Pass1 Batch2 checkpoint

- scans401–410 — **TEXT-COMPLETE / cumulative 20/30**
- observed printed folios — **394–404**
- scan403 — **two-folio spread carrying printed396–397**
- textual / visual — **needs-review / needs-review**
- unresolved source-reading holds — **0**
- Pass2A — **blocked until Pass1 30/30**
