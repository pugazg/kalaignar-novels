...
- representative source occurrences checked: `வற்றாப்பளையைக்` / `கூரைகளையுடைய` (`ளை`), `சிற்றார்கள்` (`றா`), `பனை` (`னை`);
...
- printed page number `18` is centered in the dark circular footer marker;
- paragraph/block separation remains ordinary narrative structure with no non-body insert.
...
<!-- மூல மொத்த ஸ்கேன் பக்கம்: 29; பகுதி: 001; பகுதி உள்ளூர் பக்கம்: 29; அச்சுப் பக்கம்: 18; PASS 2A + PASS 2B + PASS 3 REVIEWED / needs-review -->
