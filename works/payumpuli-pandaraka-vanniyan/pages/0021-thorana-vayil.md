...
- representative source occurrences checked: `காட்டாற்று` (`றா`), `பாளையக்கார` (`ளை`), `கெண்டைக்காலைப்` (`லை`), `மற்றொரு` (`றொ`);
...
- source-visible chapter opening uses a large black ornamental banner carrying `ஒரு இரகசியக் கடிதம்!`;
- chapter number `2` is displayed separately in a shield-like ornament at the upper left beneath the banner;
- `1798 ஆம் ஆண்டு!` is a distinct centered dateline beneath the chapter furniture before body prose begins;
- body prose sits within the rounded framed page layout; printed page number `10` is centered in the dark circular footer marker.
...
<!-- மூல மொத்த ஸ்கேன் பக்கம்: 21; பகுதி: 001; பகுதி உள்ளூர் பக்கம்: 21; அச்சுப் பக்கம்: 10; PASS 2A + PASS 2B + PASS 3 REVIEWED / needs-review -->
