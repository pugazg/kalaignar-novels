...
- the bottom location/date and publisher imprint are printed matter and are retained separately by line;
...
- representative source occurrences checked on this scan: `கலைஞர்` (`லை`), `சென்னை` (`னை`);
...
- source-visible stylized `பதிப்புரை` heading appears at the top;
- unlike scans6–9, this page has no enclosing ornate border; faint reverse show-through is non-body matter;
- bottom matter is structurally split: `சென்னை-32 / 6-5-91` at lower left and publisher imprint at lower right;
- no printed page number is visible.
...
<!-- மூல மொத்த ஸ்கேன் பக்கம்: 10; பகுதி: 001; பகுதி உள்ளூர் பக்கம்: 10; அச்சுப் பக்கம்: —; PASS 2A + PASS 2B + PASS 3 REVIEWED / needs-review -->
