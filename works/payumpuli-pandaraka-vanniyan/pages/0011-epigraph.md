...
- representative source occurrences checked on this scan: `போயிற்றா` / `மாற்றார்` (`றா`), `தலையும்` (`லை`);
...
- the page uses a thin rounded rectangular frame with a heavy ornamental baseline at the foot;
- the eight-line verse is a centered display block in the lower-middle of the page; the attribution is set separately to the right beneath it;
- faint reverse show-through is non-body matter; no printed page number is visible.
...
<!-- மூல மொத்த ஸ்கேன் பக்கம்: 11; பகுதி: 001; பகுதி உள்ளூர் பக்கம்: 11; PASS 2A + PASS 2B + PASS 3 REVIEWED / needs-review -->
