...
## Non-body printed matter

Illustration caption printed beside the figure:
...
- the large warrior figure is illustration matter; its printed caption is retained separately from narrative prose;
...
- representative source occurrences checked on this scan: `எல்லைகளாகக்` / `எல்லைப்புறத்தில்` (`லை`);
...
- a large framed warrior illustration occupies the upper half of the page;
- its printed caption is set separately in a narrow stacked block to the left of the illustration and remains non-body printed matter;
- narrative prose resumes below the illustration;
- printed page number `6` is centered in the dark circular footer marker.
...
<!-- மூல மொத்த ஸ்கேன் பக்கம்: 17; பகுதி: 001; பகுதி உள்ளூர் பக்கம்: 17; PASS 2A + PASS 2B + PASS 3 REVIEWED / needs-review -->
