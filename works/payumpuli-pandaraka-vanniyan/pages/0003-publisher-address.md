...
- representative source occurrences checked on this scan: `சென்னை` (`னை`);
...
- publisher/address block occupies the lower-left portion of an otherwise mostly blank page;
- a partial blue/purple circular library stamp is visible well above the printed block and remains copy-specific non-body matter;
- no printed page number is visible.
...
<!-- மூல மொத்த ஸ்கேன் பக்கம்: 3; பகுதி: 001; பகுதி உள்ளூர் பக்கம்: 3; அச்சுப் பக்கம்: —; PASS 2A + PASS 2B + PASS 3 REVIEWED / needs-review -->
