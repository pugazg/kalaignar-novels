# Source Intake — பாயும்புலி பண்டாரக வன்னியன் — Part 008
...
- Part 008 local page 1 = overall scan **211**;
- Part 008 local page 30 = overall scan **240**;
...
The canonical `scan_page` remains the overall scan number **211–240**.
...
- printed pages — **212–221**
- chapter34 `கடவுள் யார் பக்கம்!` — scans221–225 continuation/close
- scan225 preserves a substantial intentional blank lower field
