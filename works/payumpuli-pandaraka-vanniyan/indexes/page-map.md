...
| 005 | 1 | 121 | 111 | `இருவர் உள்ளம்` continuation; audited 120→121 split preserved; Pass3 reviewed | verified | `pages/0121-iruvar-ullam.md` |
| 005 | 2 | 122 | 112 | chapter16 opening `பண்டாரகனின் சகோதரிகள்!`; Pass3 reviewed | verified | `pages/0122-pandaarakanin-sakotharigal.md` |
| 005 | 3 | 123 | — | full-page colour illustration; no printed text or visible folio; Pass3 reviewed | verified | `pages/0123-pandaarakanin-sakotharigal.md` |
| 005 | 4 | 124 | 114 | `பண்டாரகனின் சகோதரிகள்!` continuation after illustration; Pass3 reviewed | verified | `pages/0124-pandaarakanin-sakotharigal.md` |
| 005 | 5 | 125 | 115 | `பண்டாரகனின் சகோதரிகள்!` continuation; Pass3 reviewed | verified | `pages/0125-pandaarakanin-sakotharigal.md` |
| 005 | 6 | 126 | 116 | `பண்டாரகனின் சகோதரிகள்!` continuation; Pass3 reviewed | verified | `pages/0126-pandaarakanin-sakotharigal.md` |
| 005 | 7 | 127 | 117 | `பண்டாரகனின் சகோதரிகள்!` continuation; Pass3 reviewed | verified | `pages/0127-pandaarakanin-sakotharigal.md` |
| 005 | 8 | 128 | 118 | `பண்டாரகனின் சகோதரிகள்!` close; large intentional blank lower field; Pass3 reviewed | verified | `pages/0128-pandaarakanin-sakotharigal.md` |
| 005 | 9 | 129 | 119 | chapter17 opening `கண்டிப் பயணம்!`; Pass3 reviewed | verified | `pages/0129-kandip-payanam.md` |
| 005 | 10 | 130 | 120 | `கண்டிப் பயணம்!` continuation with displayed verse; Pass3 reviewed | verified | `pages/0130-kandip-payanam.md` |
| 005 | 11 | 131 | 121 | `கண்டிப் பயணம்!` continuation; displayed verse + prose; Pass3 reviewed | verified | `pages/0131-kandip-payanam.md` |
| 005 | 12 | 132 | 122 | `கண்டிப் பயணம்!` continuation; Pass3 reviewed | verified | `pages/0132-kandip-payanam.md` |
| 005 | 13 | 133 | 123 | `கண்டிப் பயணம்!` continuation; Pass3 reviewed | verified | `pages/0133-kandip-payanam.md` |
| 005 | 14 | 134 | 124 | `கண்டிப் பயணம்!` close; large intentional blank lower field; Pass3 reviewed | verified | `pages/0134-kandip-payanam.md` |
| 005 | 15 | 135 | 125 | chapter18 opening `நண்பர்கள் சந்திப்பு!`; Pass3 reviewed | verified | `pages/0135-nanbargal-santhippu.md` |
| 005 | 16 | 136 | 126 | `நண்பர்கள் சந்திப்பு!` continuation; Pass3 reviewed | verified | `pages/0136-nanbargal-santhippu.md` |
| 005 | 17 | 137 | 127 | `நண்பர்கள் சந்திப்பு!` continuation; Pass3 reviewed | verified | `pages/0137-nanbargal-santhippu.md` |
| 005 | 18 | 138 | 128 | `நண்பர்கள் சந்திப்பு!` continuation; Pass3 reviewed | verified | `pages/0138-nanbargal-santhippu.md` |
| 005 | 19 | 139 | 129 | `நண்பர்கள் சந்திப்பு!` continuation; Pass3 reviewed | verified | `pages/0139-nanbargal-santhippu.md` |
| 005 | 20 | 140 | 130 | chapter19 opening `மனமில்லா மணம்!`; ends mid-word `அரண்`; Pass3 reviewed | verified | `pages/0140-manamillaa-manam.md` |
| 005 | 21 | 141 | 131 | `மனமில்லா மணம்!` continuation; joins scan140 `அரண்` → `மனையின்`; Pass3 reviewed | verified | `pages/0141-manamillaa-manam.md` |
| 005 | 22 | 142 | 132 | `மனமில்லா மணம்!` continuation; Pass3 reviewed | verified | `pages/0142-manamillaa-manam.md` |
| 005 | 23 | 143 | 133 | `மனமில்லா மணம்!` continuation; Pass3 reviewed | verified | `pages/0143-manamillaa-manam.md` |
| 005 | 24 | 144 | 134 | `மனமில்லா மணம்!` continuation; Pass3 reviewed | verified | `pages/0144-manamillaa-manam.md` |
| 005 | 25 | 145 | 135 | `மனமில்லா மணம்!` close; large intentional blank lower field; Pass3 reviewed | verified | `pages/0145-manamillaa-manam.md` |
| 005 | 26 | 146 | 136 | chapter20 opening `சதி வலை!`; Pass3 reviewed | verified | `pages/0146-sathi-valai.md` |
| 005 | 27 | 147 | 137 | `சதி வலை!` continuation; Pass3 reviewed | verified | `pages/0147-sathi-valai.md` |
...
| 013 | 1 | 361 | 354 | chapter58 opening `அதிலே இது ஒன்று!`; incoming 360→361 clean chapter boundary audited; ends physical split `உன் ரத்` | verified | `pages/0361-athile-idhu-ondru.md` |
| 013 | 2 | 362 | 355 | `அதிலே இது ஒன்று!` continuation; resumes `தத்தை`; ends mid-comparison `ஆனால்` | verified | `pages/0362-athile-idhu-ondru.md` |
| 013 | 3 | 363 | 356 | `அதிலே இது ஒன்று!` continuation; resumes `செந்நிறமாக`; ends physical continuation `தேடக்` | verified | `pages/0363-athile-idhu-ondru.md` |
| 013 | 4 | 364 | 357 | `அதிலே இது ஒன்று!` continuation; resumes `கிடைக்காத அமுதமே`; ends complete sentence | verified | `pages/0364-athile-idhu-ondru.md` |
| 013 | 5 | 365 | 358 | `அதிலே இது ஒன்று!` close; substantial intentional blank lower field | verified | `pages/0365-athile-idhu-ondru.md` |
| 013 | 6 | 366 | 359 | chapter59 opening `இன்று முதல் உங்கள் எதிரி!`; displayed number 59 | verified | `pages/0366-indru-mudhal-ungal-edhiri.md` |
| 013 | 7 | 367 | 360 | `இன்று முதல் உங்கள் எதிரி!` continuation; ends open dialogue at `பியசீலியைக்` | verified | `pages/0367-indru-mudhal-ungal-edhiri.md` |
| 013 | 8 | 368 | 361 | `இன்று முதல் உங்கள் எதிரி!` continuation; resumes `கண்டிக்கு`; ends open dialogue at `நீங்கள்` | verified | `pages/0368-indru-mudhal-ungal-edhiri.md` |
| 013 | 9 | 369 | 362 | `இன்று முதல் உங்கள் எதிரி!` continuation; resumes `இவளுக்கு`; ends physical continuation `கொழும்பு` | verified | `pages/0369-indru-mudhal-ungal-edhiri.md` |
| 013 | 10 | 370 | 363 | `இன்று முதல் உங்கள் எதிரி!` continuation; resumes `வந்து சேர்ந்தார்.`; chapter continues on371 | verified | `pages/0370-indru-mudhal-ungal-edhiri.md` |
| 013 | 11 | 371 | 364 | chapter59 `இன்று முதல் உங்கள் எதிரி!` close; substantial intentional blank lower field | verified | `pages/0371-indru-mudhal-ungal-edhiri.md` |
| 013 | 12 | 372 | 365 | chapter60 opening `பகையும் - பண்பும்!`; displayed number 60; ends physical continuation `தேவை` | verified | `pages/0372-pagaiyum-panbum.md` |
| 013 | 13 | 373 | 366 | `பகையும் - பண்பும்!` continuation; resumes `களை`; war-preparation discussion | verified | `pages/0373-pagaiyum-panbum.md` |
| 013 | 14 | 374 | 367 | `பகையும் - பண்பும்!` continuation; Martthani returns; ends `பியசீலி என்ன ஆனாள்? சொல்லுங்கள்!` | verified | `pages/0374-pagaiyum-panbum.md` |
| 013 | 15 | 375 | 368 | `பகையும் - பண்பும்!` continuation; missing-foot reveal; ends `விபரமாகச் சொல்லு!` | verified | `pages/0375-pagaiyum-panbum.md` |
| 013 | 16 | 376 | 369 | `பகையும் - பண்பும்!` continuation; treatment account; ends open sentence `நான் அவர்களின்` | verified | `pages/0376-pagaiyum-panbum.md` |
| 013 | 17 | 377 | 370 | `பகையும் - பண்பும்!` close; resumes `விரோதி என்று தெரிந்தும்`; final `மென்காற்றில்!` | verified | `pages/0377-pagaiyum-panbum.md` |
...
- chapter52 `மயங்குகிறாள் ஒரு மாது!` — continues331–335 / closes335
- chapter53 `மற்றொரு மதுரை?` — opens336 / continues through340
- unresolved Pass1 source-reading holds — **0**
- completed records — `status: "needs-review"` / `visual_fidelity: "needs-review"`
...
- scans331–340 — **verified textual status**
- scans341–360 — **needs-review textual status**
- corrections — **0**
...
- Batch1 source-supported corrections — **6**
...
- Batch2 source-supported corrections — **10**
...
## Part013 Pass2B closure checkpoint
...
- scans361–370 / local1–10 / printed354–363 — **VISUAL-STRUCTURAL REVIEWED / PASS**
- Pass3 textual corrections — **0**
- unresolved visual / structural questions — **0**
- displayed chapter openings — **58/scan361, 59/scan366**
- substantial intentional blank lower field — **scan365**
- textual status — **30/30 verified**
- visual fidelity — **30/30 needs-review**
- outgoing **390→391 — PENDING direct audit**
