...
| Tamil source | English policy | Decision |
|---|---|---|
| `பலிபீடம்` | **sacrificial altar** | governing metaphor; do not alternate casually with shrine/platform/scaffold |
| `பலிபீடம் நோக்கி` | **Towards the Sacrificial Altar** | working English title |
| `பலிபீடம் நோக்குங்கள்` | **turn / look towards the sacrificial altar** according to immediate syntax | retain directional force of `நோக்கு` |
| `பலிபீடம் நோக்கிகளே` | **O you bound for / facing the sacrificial altar** | preserve coined rhetorical address |
| `ஆரியம்` | **Aryanism** when functioning as an ideological/social force; **Aryan** adjectivally | do not recast as modern racial science |
...
| `கன்னிகாதானம்` | **kanyadanam** | retain ritual term; do not flatten to generic “marriage” |
...
| Tamil source | English form | Note |
|---|---|---|
...
- `டைரக்ஷன்` → **Direction**
- `திரைக்கதை அமைப்பு` → **screenplay arrangement**
- `வசனம்` → **dialogue**
- `விநியோக உரிமை` → **Distribution rights**
