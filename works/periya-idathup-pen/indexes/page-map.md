...
> **Verification freeze:** no page in this work is to be marked `verified` under the current user instruction. All 49 canonical records remain `needs-review`. Historical Tamil glyph handling follows [`../HISTORICAL_GLYPH_AUDIT.md`](../HISTORICAL_GLYPH_AUDIT.md) and the reusable root [`HISTORICAL_TAMIL_GLYPH_TRANSCRIPTION_GUIDE.md`](../../../HISTORICAL_TAMIL_GLYPH_TRANSCRIPTION_GUIDE.md).

| Scan | Printed page | Page type / section | Status | File |
|---:|:---:|---|---|---|
| 1 | — | cover — `பெரிய இடத்துப் பெண்` | needs-review | `pages/0001-cover.md` |
| 2 | — | copy annotation / gift label | needs-review | `pages/0002-copy-annotation.md` |
...
| 6 | — | eighth-edition note | needs-review | `pages/0006-eighth-edition-pathippurai-01.md` |
...
| 15 | 14 | internal heading `உத்தண்டி` | needs-review | `pages/0015-periya-idathup-pen-08.md` |
...
| 19 | 18 | internal heading `கண்ணம்மா`; source-text correction | needs-review | `pages/0019-periya-idathup-pen-12.md` |
