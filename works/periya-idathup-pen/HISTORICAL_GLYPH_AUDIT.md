...
The chart is a decoding reference, not permission to modernize wording, spelling, grammar, punctuation or vocabulary. Every occurrence must be checked against its own source pixels; no global replacement is allowed.
...
|---:|:---:|---|---|
| 4 | — | `சமூகத்தின்` | `சமுதாயத்தின்` |
| 5 | — | `அற்பிய` | `அரும்பிய` |
| 5 | — | `சமூகமும்` | `சமுதாயம்` |
| 7 | 6 | `உள்ளங்களை` | `உள்ளங்களே` |
| 12 | 11 | `தாவும்போது பயப்பட்ட பூனை` | `தாவும்போது பயப்படாத பூனை` |
