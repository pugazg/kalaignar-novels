...
- corrected `குளிர் மொழிகளை` → source **`குளிர் மொழிகள்`**;
- corrected `ஆடு வளர்க்கும் கிழ மட்டுமே` → source **`ஆடு வளர்க்கும் கலை மட்டுமே`**;
- the second correction is a retrospectively caught historical `லை` identity that T2 had missed;
- scan 39→40 join and printed page **37** were reconfirmed;
