...
|---|---|---|
| `அரும்பு` | **bud**; working title **The Bud** | **LOCKED** — preserve recurring botanical/child metaphor |
| `கோகுல்` | **Gokul** | **LOCKED** |
...
| `புதுமை முறை` | **new-style / new-style manner** | **LOCKED** — do not import an unprinted movement label |
| `அறிவு முறை` | **a rational manner** | **LOCKED** |
| `வாழ்க்கை ஒப்பந்த விழா` | **life-contract ceremony** | **LOCKED** |
| `அக்கினி` | **Agni** | **LOCKED** |
| `அருந்ததி` | **Arundhati** | **LOCKED** |
| `கிரகண` | **“eclipse”** | **LOCKED** |
| `அபிநய` | **abhinaya** | **LOCKED** |
| `லீவு` | **leave** | **LOCKED** |
| `சிகரெட்` | **cigarette** | **LOCKED** |
| direct `அப்பா` | **Appa** in emotional/direct address; **father** in narration | **LOCKED** |
| non-kin vocative `யம்மா / ம்மா` | contextual **my dear / dear** | **LOCKED** |
| `ஒப்பாரி` | **oppari** | **LOCKED** |
| `ஆராரோ` | **Aararo** | **LOCKED** |
| `காக்கா பிடிக்க` | **curry favour** | **LOCKED** |
| `பாட்டி` in direct address | **Paatti** | **LOCKED** |
| `அத்தை மகன்` | **aunt's son** | **LOCKED** |
| `பொட்டு` | **pottu** | **LOCKED** |
