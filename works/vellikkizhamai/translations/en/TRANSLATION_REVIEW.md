# Final Bilingual Review — வெள்ளிக்கிழமை / Friday
...
When opened, review the whole work end-to-end for:

1. 23 / 23 chapter coverage and ordering;
2. no omitted Tamil paragraph/dialogue unit;
3. no duplicated source span;
4. no material source-like addition;
5. correct speaker attribution and agency;
6. names, shortened forms, relationships and places;
7. religious, caste and socially charged terminology;
8. rhetorical questions, repetition, irony, insult and emotional force;
9. dialogue/quotation integrity;
10. all chapter-boundary and page-boundary joins;
11. literal source discontinuities at scans 117→118, 122→123 and 156→157;
12. page/scan provenance comments;
