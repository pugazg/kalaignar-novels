...
**VERIFIED / historical-glyph PASS.** Continues scan 118 with source-visible `வருகிறேன்.........`; source-confirmed `ஓடினாள்`; preserve `பதைக்`, `வஞ்சங்`, `நச்சரவு`, `ஜாடையாக`; ends `கவனித்து`.

### Scan 120 / printed 119
**VERIFIED / historical-glyph PASS.** Begins `விட்டான்.`; mixed Chapter 14 / 15 boundary with centered `15`; source-confirmed `நின்றாள்` and the one visible `எண்ணினான்`; separate source word `ஏங்கினான்` retained. The earlier target list's “both `எண்ணினான்`” is superseded by direct scan inspection.

### Scan 121 / printed 120
**VERIFIED / historical-glyph PASS.** Source-confirmed `குமுறினாள்`, `அலறினாள்`, and both `ஓடினான்` occurrences; preserve `கரந்தொட்டுப்`, `ஆத்திரமனைத்தையும்`, `அவன்கையில்`, `புறப்படத்தயாராக`; ends `வண்டியில்`.

### Scan 122 / printed 121
**VERIFIED / historical-glyph PASS.** Begins `ஒரே கூட்டம்.`; source-confirmed `வருகிறானா`, `போகிறாள்`, `கிளம்பியிருக்கிறாள்`; preserve `தீமரென`, `தொத்திக்கொண்டான்`, `பலகணி`; ends `சிந்தாமணி, அவளுக்குப் பக்கத்திலே`.
