...
- Opening `கார்ந்துகொண்டு` completes scan 96’s final `ஒரு நாற்காலியில் உட்`, forming the physical `உட்கார்ந்துகொண்டு` across scans.
- Final `நயினா` continues physically with scan 98 `வைத் தாக்காமல் இல்லை`, forming `நயினாவைத் தாக்காமல் இல்லை`.
