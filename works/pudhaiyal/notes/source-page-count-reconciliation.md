...
- canonical records currently created through scan **312**;
...
## Part-007 structural state through scan 312
...
- scan 310 — source-printed four-star internal transition and physical ending `போவ`;
- scan 311 begins `தென்று`, completing `போவதென்று`, and ends `பேசிக் கொண்டிருந்து`;
- scan 312 begins `விட்டு,`; no new complete baseline lexical omission was found on scans 308–312.
...
- canonical page records created: **312**
...
- later completed pages: through scan **312**, except the nine `needs-review` records
- Parts 001–006: **part-complete at split level**
- Part 007: **canonical-in-progress; 31 scans remain**
...
1. complete Part-007 canonical/structural reconciliation for scans 313–343;
...
Process **scan 313 / printed 309** from `p7.md` plus native Part-007 page 19 and continue sequentially through the derivative.