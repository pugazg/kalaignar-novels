...
- canonical records currently created through scan **317**;
...
## Part-007 structural state through scan 317
...
- scan 307 — chapter 35 begins under heading `35`;
- scan 310 — source-printed four-star internal transition;
- scan 313→314 — `தன் படுக்கையைத்` continues as `திண்ணையிலே...`;
- scan 315 — baseline omits source-visible complete quoted span `சரி...... வா! வா!......`; canonical status `needs-review`, no source insertion;
...
- canonical page records created: **317**
...
- later completed pages: through scan **317**, except the ten `needs-review` records
- Parts 001–006: **part-complete at split level**
- Part 007: **canonical-in-progress; 26 scans remain**
...
1. complete Part-007 canonical/structural reconciliation for scans 318–343;
2. explicitly resolve/disposition Part-007 baseline omissions at scans 304–305 and 315;
...
Process **scan 318 / printed 314** from `p7.md` plus native Part-007 page 24, verifying `பரிமளா பங்களாவிலே` → `இருந்ததால் புலனாகிவிட்டது...`, then continue sequentially through the derivative.