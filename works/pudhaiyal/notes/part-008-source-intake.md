...
- `TVA_BOK_0064097_புதையல்_part_008_pages_344-392.pdf`
- physical pages: **49**
...
`p8.md` controls lexical wording under the scan-280-onward rule; native pages control structure.

## Boundary / mapping

Part 007 scan 343 ends `அதிர்ஷ்`; Part 008 scan 344 starts `டம் அடிக்குது!`, proving **`அதிர்ஷ்டம் அடிக்குது!`** across the split.
