...
- The first `உதவுகிறது.` in the prayer ends with a full stop in the scan; it has not been changed to an exclamation mark.
- Source dash placement and `குளிர்காற்று` are retained.
