...
- Native scan confirms a full stop after `மூர்ச்சை யடைந்தான்.`; the earlier assistant claim that punctuation was absent is withdrawn.
- Native scan confirms `அவனைத் தழுவிக்`, `முயன்றும்—விடாமல்`, and `கட்டிவிட்டார்`.
- Source punctuation was reconciled directly from the native image.
