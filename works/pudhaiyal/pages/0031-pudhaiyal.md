...
- Backward integrity re-audit confirms that no full stop is printed after `மூர்ச்சை யடைந்தான்`; the earlier assistant-inserted stop is withdrawn.
- The source prints `அவனைத்தழுவிக்` continuously; the earlier assistant spacing `அவனைத் தழுவிக்` is withdrawn.
- `முயன்றும்—விடாமல்` and `கட்டிவிட்டார்` remain source-supported.
