...
transcription_method: "user-supplied Iteration 22 baseline reconciled directly against native split part 005 page 43 image"
---
...
- Source prints `வரவில்ல`, retained without normalization.
- Baseline `தன் ஆசை அத்தானை` is corrected from native pixels to source `தன் ஆசை அத்தான்`.
