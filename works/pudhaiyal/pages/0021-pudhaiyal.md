...
- Fresh high-resolution re-audit corrects the earlier fused assistant reading: the scan supports `அடிபட்டு விட்டதால்`, not `அடிபட்டுவிட்டதால்`.
- The source's colloquial `நுழைஞ்சு`, `தீரணும்`, `புடிச்சுடலாம்` and the phrase `சுற்று முற்றும்` remain retained.
