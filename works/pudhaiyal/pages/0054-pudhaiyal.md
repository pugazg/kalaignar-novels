...
The physical scan ends at `போயி`; the continuation begins scan 55 with `யைப்பாரு!`.

## Verification note

Direct comparison with split part 002 page 5 / printed page 52 completed. The clean-baseline `சேட்கிறீயா` was corrected to the visibly printed `கேட்கிறீயா`; source punctuation was restored. No unresolved reading remains.
