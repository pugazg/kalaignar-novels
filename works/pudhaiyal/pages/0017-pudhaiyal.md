...
- Fresh high-resolution re-audit confirms `ஆராய்ந்து விட்டோம்`, not the earlier assistant misread `ஆராய்ந்து விட்டோமே`.
- The scan also supports `இடையிலே தான்` and `சரியாகத் தான்`; earlier fused forms are withdrawn.
- Source form `இந்த ஆண்டவனுக்கு மிடையிலே` remains retained.
