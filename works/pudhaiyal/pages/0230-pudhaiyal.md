...
transcription_method: "user-supplied Iteration 21 baseline reconciled directly against native split part 005 page 34 image; old-glyph reinspection 2026-08-30"
---
...
- High-resolution old-type reinspection confirms both baseline `எதுவுமில்லை` readings; the earlier assistant `எதுவுமில்ல` readings are withdrawn.
