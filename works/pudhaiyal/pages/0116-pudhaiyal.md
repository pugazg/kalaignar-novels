...
Fresh native-image re-audit completed. Source-established forms include `செத்துப்போயி கூட`, separated `நான் தான்`, `நல்ல முடிவு தம்பி!`, and `படித்து விட்டு`. Earlier joined/altered assistant forms are withdrawn.
