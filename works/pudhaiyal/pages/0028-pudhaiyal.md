...
- Native scan confirms `அவன் முதுகில்`; the restored baseline's `அவன முதுகில்` was corrected.
- Source punctuation and spacing were reconciled directly from the native image.
