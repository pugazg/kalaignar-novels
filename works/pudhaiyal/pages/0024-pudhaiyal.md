...
- Source-supported oddity `அவர்களே நோக்கி` is retained rather than regularized to `அவர்களை நோக்கி`.
- The scan prints `அப்போது தான்` as separate words and `ஆறுதல் அளித்தது`; these are retained exactly.
