...
| Part 006 | 246–294 | **in progress — 49 mapped; scans 246–274 verified; 275–294 not-started** |
...
- latest fidelity record: [`notes/visual-fidelity-scan-274.md`](notes/visual-fidelity-scan-274.md)
...
Scan **274 / printed 270** is now source-verified:

- 273→274 continuity is **`மறு` + `படியும்` = `மறுபடியும்`**;
- user Iteration-26 wording is substantively source-supported;
- source punctuation is `“புதையல்! புதையல்!! புதையல் ரகசியம்!!!”—`;
- source reads **`எரியும்போது`**, not baseline `எரியும் போது`;
...
Only scans 246–274 have been textually reconciled so far. Later structural mapping does not make scans 275–294 `verified`.

## Aggregate archival status

- canonical Tamil page records: **274**
- verified: **267**
- needs-review: **7 — scans 215–219, 223–224**
- partial: **0**
- clean contiguous fully verified range remains through scan **214 / printed page 212**
- later individual scans are source-verified through scan **274**, except the seven Part-005 damaged scans
...
Reconcile **scan 275 / printed page 271** directly against native Part-006 pixels, continuing chapter 31. Apply the strengthened two-pass rule to every vowel sign and line-wrap question before overriding any baseline character or word spacing. Do not begin downstream Part-006 gates until all 49 physical pages have canonical records.