...
> This derivative-local map records the completed Part-004 source range. The split is an access derivative of the same edition, not a separate work or narrative boundary.
...
| 158 | 156 | chapter 17; ends `டாக்` | verified | `../pages/0158-pudhaiyal.md` |
...
| 187 | 185 | chapter 20 closes / chapter 21 begins | verified | `../pages/0187-pudhaiyal.md` |
| 188 | 186 | chapter 21 | verified | `../pages/0188-pudhaiyal.md` |
...
- bilingual English review: **PASSED**
- Part 004 state: **`part-complete`**
...
- [`../notes/visual-fidelity-scans-178-187.md`](../notes/visual-fidelity-scans-178-187.md)
- [`../notes/visual-fidelity-scans-188-196.md`](../notes/visual-fidelity-scans-188-196.md)

Audit: [`../notes/part-004-tamil-audit.md`](../notes/part-004-tamil-audit.md).  
Bilingual review: [`../translations/en/PART_004_REVIEW.md`](../translations/en/PART_004_REVIEW.md).

The next split must begin with **source scan 197** and continue source-printed chapter 22. Do not infer any missing continuation before inspecting that native source page.
